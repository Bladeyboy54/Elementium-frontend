        ...
        <div className={styles.main}>
            <div className={styles.content}>
                ...
                <div className={styles.info}>
                    ...
                    <div className={[styles.accountTypeSection, styles.infoSection].join(' ')}>
                        <p className={styles.title}>Account Type</p>
                        <p className={styles.value}>Transition</p>
                    </div>
                    <div className={[styles.transactionsSection, styles.infoSection].join(' ')}>
                        <p className={styles.title}>Balance</p>
                        <p className={styles.value}>ZAR 24,000.00</p>
                    </div>
                    <div className={[styles.cardsSection, styles.infoSection].join(' ')}>
